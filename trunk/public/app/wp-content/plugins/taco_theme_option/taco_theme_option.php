...
/**
 * Plugin Name: taco_theme_option
 * Version: 1.0
 * Description: Theme options
 */
if(!class_exists('TacoThemeOptionBase')) {
...
class ThemeOption extends \Taco\Post {
  ...
  public function getFields() {
    return array_merge(self::getBaseFields(), array(
      ...
      //'social_pinterest'=>array('type'=>'text', 'label'=>'Pinterest', 'default'=>''),
      //'social_instagram'=>array('type'=>'text', 'label'=>'Instagram', 'default'=>''),
      'social_youtube'=>array('type'=>'text', 'label'=>'YouTube', 'default'=>'ReadingPartners'),
      'social_linkedin'=>array('type'=>'text', 'label'=>'LinkedIn', 'default'=>'reading-partners'),
